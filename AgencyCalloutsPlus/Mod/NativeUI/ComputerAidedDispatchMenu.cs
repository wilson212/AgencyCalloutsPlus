...
namespace AgencyCalloutsPlus.Mod.NativeUI
{
    ...
    public static class ComputerAidedDispatchMenu
    {
        ...
        private static void ScenarioItem_Activated(RAGENativeUI.UIMenu sender, UIMenuItem selectedItem)
        {
            ...
            {
                Game.DisplaySubtitle("~b~Call created! You will be dispatched to this call once you exit the menu", 5000);
            }
            else
            {
        ...
        /// <summary>
        /// Method to be called on every <see cref="Game.FrameRender"/> event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
