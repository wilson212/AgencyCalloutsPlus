...
namespace AgencyCalloutsPlus.Mod.UI
{
    ...
    internal class TextElement : IElement
    {
        ...
        /// </value>
        public GameFont Font { get; set; } = GameFont.ChaletLondon;
        ...
        /// 
        /// </returns>
        public static SizeF GetStringSize(string text, GameFont font = GameFont.ChaletLondon, float scale = 1.0f, float size = 1.0f)
        {
