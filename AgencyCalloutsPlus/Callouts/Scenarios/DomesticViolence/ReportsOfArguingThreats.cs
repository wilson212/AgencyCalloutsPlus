...
namespace AgencyCalloutsPlus.Callouts.Scenarios.DomesticViolence
{
    ...
    internal class ReportsOfArguingThreats : CalloutScenario
    {
        ...
        /// </summary>
        public ResidenceLocation Residence { get; protected set; }
        ...
        public override void Setup()
        {
            ...
            SuspectGender = random.PickOne(Gender.Male, Gender.Female);
            VictimGender = (SuspectGender == Gender.Male) ? Gender.Female : Gender.Male;
            ...
            SpawnId = HomeSpawnId.BackYardPed; //random.PickOne(HomeSpawnId.FrontDoorPed, HomeSpawnId.BackYardPed);

            // Create a marker for the player to walk into
            CheckpointPosition = Residence.GetSpawnPoint(HomeSpawnId.PolicePed1);
